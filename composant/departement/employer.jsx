...
function Employer() {
  ...
  const loadEmployeeData = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8000/api/employee-data"
      );
      ...
      // Calculer les stats à partir des tâches
  ...
  const renderTaskCard = (task, isSmall = false) => {
    const cardClass = isSmall
      ? "bg-white/5 rounded-lg p-3 border border-white/5"
      : `bg-white/10 backdrop-blur-lg border rounded-2xl p-6 ${
                ...
                >
                  <div className="mb-4">
                    ...
                    <div className="text-sm text-white/60">
                      ...
                      <div>Mes tâches: {projectTasks.length}</div>
                    </div>
                  </div>
      ...
      <div className="space-y-4">
        {myTasks.length > 0 ? (
          ...
          <div className="text-center py-12 text-white/50">
            ...
            <h3 className="text-xl font-medium mb-2">Aucune tâche assignée</h3>
            <p>Vos nouvelles tâches apparaîtront ici.</p>
          </div>
        )}
      </div>
    </div>
    ...
    <div>
      ...
      <div className="space-y-6">
        {myProjects.length > 0 ? (
                ...
                <div>
                  ...
                  {projectTasks.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {projectTasks.map((task) => renderTaskCard(task, true))}
                    </div>
                  ) : (
                    <div className="text-center py-6 text-white/50 bg-white/5 rounded-lg">
          ...
          <div className="text-center py-12 text-white/50">
            <div className="text-6xl mb-4">📁</div>
            <h3 className="text-xl font-medium mb-2">Aucun projet assigné</h3>
            <p>Vos nouveaux projets apparaîtront ici.</p>
          </div>
        )}
      </div>
    </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="bg-white/10 backdrop-blur-sm border border-white/20 p-3 rounded-2xl text-white hover:bg-white/20 transition-all duration-300 group"
                title="Paramètres"
              >
                <svg
